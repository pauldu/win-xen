...
_hypercall_2@12    proc
                        ...
                        shl     eax, 5
                        add     eax, dword ptr [_HypercallBase]
                        call    eax
                        pop     ebx
                        leave
                        ret     0Ch
_hypercall_2@12    endp

                        ; uintptr_t __stdcall asm__hypercall3(uint32_t ord, uintptr_t arg1, uintptr_t arg2, uintptr_t arg3);
                        public _hypercall_3@16
_hypercall_3@16    proc
                        push    ebp
                        mov     ebp, esp
                        push    ebx
                        mov     eax, [ebp + 08h]                ; ord
